...
export enum PaymentRequestType {
    ...
    // Chi phí phát sinh khi task được phân công cho vendor - hệ thống tự tạo
...
export interface PaymentRequestHistoryEntry {
    action: "CREATED" | "SUBMITTED" | "SUPPLEMENTED" | "REVIEWED" | "BOD_DECISION" | "PAID";
    at: string;
    byId: string;
    byName?: string | null;
    note?: string | null;
...
export class PaymentRequests extends BaseEntity {
    ...
    // Vendor liên quan (chỉ có giá trị với type = VENDOR_EXPENSE, chi phí phát sinh do task giao cho vendor)
    @Column({ type: "varchar", length: 26, nullable: true })
