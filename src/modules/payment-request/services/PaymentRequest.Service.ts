...
export class PaymentRequestService {
    ...
    /**
     * Tự động tạo yêu cầu thanh toán "Chi phí phát sinh" khi một task được phân công cho vendor.
     * Thông tin được điền sẵn theo dự án/công việc/vendor; requester là người thực hiện phân công
     * (PM/Admin) vì vendor không phải tài khoản trong hệ thống. Yêu cầu tạo ở trạng thái DRAFT để
     * người phụ trách xem lại, bổ sung nội dung/hoá đơn trước khi gửi duyệt chính thức.
     */
    async createVendorExpense(data: {
        ...
        const request = repo.create({
            type: PaymentRequestType.VENDOR_EXPENSE,
    ...
    async getAll(query: PaymentRequestQuery) {
    ...
    async update(id: string, dto: any) {
        ...
        const editableFields = ["content", "amount", "dueDate", "projectId", "taskId", "invoiceImages", "invoicePdfs"];
